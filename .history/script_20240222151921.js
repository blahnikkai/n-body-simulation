...
function main() {
    ...
    // earth
    bodies.push(new Body(5.97e24, new Vector((400 + 92) * DIST_SCALE, 400 * DIST_SCALE), new Vector(0, -37983549.0706)))
    // moon ?!
    bodies.push(new Body(7.35e22, new Vector((400 + 92 + 3) * DIST_SCALE, 400 * DIST_SCALE), new Vector(0, -37983549.0706 + 3 * 1023000)))
