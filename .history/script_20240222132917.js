...
function main() {
    ...
    let bodies = []
    // sun
    bodies.push(new Body(Number('1.99e30'), new Vector(150 * DIST_SCALE, 150 * DIST_SCALE), new Vector(0, 0)))
    // earth
    bodies.push(new Body(5.97e24, new Vector((150 + 92) * DIST_SCALE, 150 * DIST_SCALE), new Vector(0, -29784000.8)))
