...
class Body {
    ...
    draw_vel(ctx) {
        ctx.beginPath()
        ctx.moveTo(this.pos.x / DIST_SCALE  - screen_x, this.pos.y / DIST_SCALE)
        ctx.lineTo((this.pos.x + this.vel.x) / DIST_SCALE  - screen_x, (this.pos.y + this.vel.y) / DIST_SCALE)
        ctx.strokeStyle = 'red'
        ctx.stroke()
    ...
    draw_acc(ctx) {
        ctx.beginPath()
        ctx.moveTo(this.pos.x / DIST_SCALE  - screen_x, this.pos.y / DIST_SCALE)
        ctx.lineTo((this.pos.x + this.acc.x) / DIST_SCALE  - screen_x, (this.pos.y + this.acc.y) / DIST_SCALE)
